...
!function (a, b) {
    ...
    function $(a, b, c) {
        var d;
        if (void 0 === c && 1 === a.nodeType)if (d = "11111-" + b.replace(Y, "-$&").toLowerCase(), c = a.getAttribute(d), "string" == typeof c) {
            try {
                c = Z(c)
            } catch (e) {
            }
        ...
        data: function (a, b) {
            ...
            if (void 0 === a) {
                if (this.length && (e = W.get(f), 1 === f.nodeType && !V.get(f, "hasDataAttrs"))) {
                    c = g.length;
                    while (c--)g[c] && (d = g[c].name, 0 === d.indexOf("11111-") && (d = r.camelCase(d.slice(5)), $(f, d, e[d])));
